                      ...
                      <div className="mt-4 pt-4 border-t border-gray-200">
                        ...
                        >
                          ...
                          <input 
                            ...
                            className="flex-1 min-w-32 px-3 py-1.5 border border-gray-200 rounded-lg bg-white text-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none" 
                          />
                          <input 
                            name="rollNo" 
                            defaultValue={s.rollNo} 
                            placeholder="Roll"
                            className="w-20 px-3 py-1.5 border border-gray-200 rounded-lg bg-white text-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none" 
                          />
                          <input 
                            name="section" 
                            defaultValue={s.section} 
                            placeholder="Section"
                            className="w-24 px-3 py-1.5 border border-gray-200 rounded-lg bg-white text-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none" 
                          />
                          <button 
                            type="submit" 
